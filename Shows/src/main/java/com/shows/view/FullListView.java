...
public class FullListView extends ListView implements OnScrollListener {
	...
	private void changeHeaderViewByState() {
		switch (state) {
			...
			case DONE:
				...
				lvHeaderProgressBar.setVisibility(View.GONE);
				lvHeaderArrowIv.clearAnimation();
				lvHeaderArrowIv.setImageResource(R.mipmap.luncher);
				lvHeaderTipsTv.setText("下拉刷新");
				lvHeaderLastUpdatedTv.setVisibility(View.VISIBLE);
				break;
		}
	...
	public void setAdapter(LvAdpter adapter) {
		lvHeaderLastUpdatedTv.setText("最近更新:" + new Date().toLocaleString());
