...
import com.com.shows.utils.DensityUtils;
...
public class GuideActivity extends BaseActivity {
	...
	private static final int[] mImageIds = new int[] { R.mipmap.one,
			R.mipmap.two, R.mipmap.three };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnStart.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(isLogin) {
//					Toast.makeText(GuideActivity.this, "未登录", Toast.LENGTH_SHORT).show();
					Intent intent = new Intent();
					intent.setClass(GuideActivity.this, ChooseLoginActivty.class);
					startActivity(intent);
				}else{
//					Toast.makeText(GuideActivity.this, "登录", Toast.LENGTH_SHORT).show();
	...
	private void initViews() {
		...
		for (int i = 0; i < mImageIds.length; i++) {
			...
			LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
					DensityUtils.dp2px(this, 15), DensityUtils.dp2px(this, 15));
			if (i > 0) {
				params.leftMargin = DensityUtils.dp2px(this, 15);// 设置圆点间隔
			}
